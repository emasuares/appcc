...
const handleSubmit =(e)=>{
    ...
    useEffect(()=>{
        getPayedAccounts().then(response=>{
    ...
    if (loading){
        ...
        return(
            ...
            <Navbar  bg="dark"  variant="dark">
                ...
                <Button variant='primary' as={Link} to={'/Nuevo-Recibo'} > Nuevo Recibo</Button>
                <Button variant='danger' as={Link} to={'/Eliminar-Recibo'} > Eliminar Recibo</Button>
                </Container>
            </Navbar>
